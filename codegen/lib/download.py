...
BURGER_COMMIT = "7e051e945e93f21c9d47f292dae3f583b1ba1531"
...
def get_pumpkin_extractor():
    if not os.path.exists(get_dir_location("__cache__/azalea-pumpkin-extractor")):
        ...
        os.system(
            f"cd {get_dir_location('__cache__')} && git clone https://github.com/urisinger/azalea-pumpkin-extractor && cd azalea-pumpkin-extractor && git pull && git reset --hard {PUMPKIN_EXTRACTOR_COMMIT}"
        )
