...
def get_burger():
    if not os.path.exists(get_dir_location("__cache__/Burger")):
        ...
        os.system(
            f"cd {get_dir_location('__cache__')} && git clone https://github.com/urisinger/Burger-occlude.git Burger && cd Burger && git pull"
        )
...
def get_pumpkin_extractor():
    if not os.path.exists(get_dir_location("__cache__/pumpkin-extractor")):
        ...
        os.system(
            f"cd {get_dir_location('__cache__')} && git clone https://github.com/urisinger/Extractor --branch models pumpkin-extractor && cd pumpkin-extractor && git pull"
        )
