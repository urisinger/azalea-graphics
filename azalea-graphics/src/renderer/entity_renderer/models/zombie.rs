use azalea_assets::processed::entity_model::Model;
use std::f32::consts::PI;

use crate::renderer::entity_renderer::{
    models::biped::BipedModel,
    state::zombie::ZombieRenderState,
...
impl<'a> ZombieModel<'a> {
    ...
    fn zombie_arms(&self, transforms: &mut ModelTransforms, attacking: bool, swing_progress: f32, animation_progress: f32) {
        ...
        // Set pitch based on attacking state
        ...
        // Swing arms
        Self::swing_arms(transforms, self.biped.right_arm, self.biped.left_arm, animation_progress);
    }

    fn swing_arms(transforms: &mut ModelTransforms, right_arm: &azalea_assets::processed::entity_model::ModelPart, left_arm: &azalea_assets::processed::entity_model::ModelPart, animation_progress: f32) {
        Self::swing_arm(transforms, right_arm, animation_progress, 1.0);
        Self::swing_arm(transforms, left_arm, animation_progress, -1.0);
    }

    fn swing_arm(transforms: &mut ModelTransforms, arm: &azalea_assets::processed::entity_model::ModelPart, animation_progress: f32, sigma: f32) {
